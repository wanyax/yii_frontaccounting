...
) ENGINE=InnoDB AUTO_INCREMENT=2 DEFAULT CHARSET=latin1 COMMENT='original: attachments';
/*!40101 SET character_set_client = @saved_cs_client */;
...
INSERT INTO `fa_attachment` VALUES (1,'2013-04-24 00:00:00',1,'2013-04-24 00:00:00',NULL,NULL,'0000-00-00 00:00:00',NULL,'attachment1','Description attachment 1',1,1,'attatch_1','2013-04-24','attachment2.pdf',789,'pdf');
...
CREATE TABLE `fa_bank_account_type` (
  ...
  PRIMARY KEY (`id`),
  UNIQUE KEY `unique1` (`name`)
) ENGINE=InnoDB AUTO_INCREMENT=4 DEFAULT CHARSET=latin1 COMMENT='original: none. source: /includes/types.inc, /includes/sysna';
/*!40101 SET character_set_client = @saved_cs_client */;
...
CREATE TABLE `fa_gl_account_class` (
  ...
  PRIMARY KEY (`id`),
  UNIQUE KEY `unique1` (`name`)
) ENGINE=InnoDB AUTO_INCREMENT=7 DEFAULT CHARSET=latin1 COMMENT='original: chart_class. source: /includes/types.inc, /include';
/*!40101 SET character_set_client = @saved_cs_client */;
...
CREATE TABLE `fa_payment_term_type` (
  ...
  PRIMARY KEY (`id`),
  UNIQUE KEY `name` (`name`)
) ENGINE=InnoDB AUTO_INCREMENT=5 DEFAULT CHARSET=latin1 COMMENT='original: none. source: /includes/types.inc, /includes/sysna';
/*!40101 SET character_set_client = @saved_cs_client */;
...
CREATE TABLE `fa_payment_type` (
  ...
  PRIMARY KEY (`id`),
  UNIQUE KEY `unique1` (`name`)
) ENGINE=InnoDB AUTO_INCREMENT=6 DEFAULT CHARSET=latin1 COMMENT='original: none. source: /includes/types.inc, /includes/sysna';
/*!40101 SET character_set_client = @saved_cs_client */;
...
CREATE TABLE `fa_quick_entry_type` (
  ...
  PRIMARY KEY (`id`),
  UNIQUE KEY `unique1` (`name`)
) ENGINE=InnoDB AUTO_INCREMENT=5 DEFAULT CHARSET=latin1 COMMENT='original: none source: /includes/types.inc, /includes/sysnam';
/*!40101 SET character_set_client = @saved_cs_client */;
...
CREATE TABLE `fa_reference` (
  ...
  PRIMARY KEY (`id`,`type`)
) ENGINE=InnoDB DEFAULT CHARSET=latin1 COMMENT='original: references. purpose: unknown. not optimal: primary';
/*!40101 SET character_set_client = @saved_cs_client */;
...
CREATE TABLE `fa_tag_type` (
  ...
  PRIMARY KEY (`id`),
  UNIQUE KEY `unique1` (`name`)
) ENGINE=InnoDB AUTO_INCREMENT=3 DEFAULT CHARSET=latin1 COMMENT='original: none. source: /includes/types.inc, /includes/sysna';
/*!40101 SET character_set_client = @saved_cs_client */;
...
CREATE TABLE `fa_transaction_type` (
  ...
  PRIMARY KEY (`id`),
  UNIQUE KEY `unique1` (`name`)
) ENGINE=InnoDB DEFAULT CHARSET=latin1 COMMENT='original: sys_types. source: /includes/types.inc, /includes/';
/*!40101 SET character_set_client = @saved_cs_client */;
...
CREATE TABLE `fa_work_order_cost_type` (
  ...
  PRIMARY KEY (`id`),
  UNIQUE KEY `name` (`name`)
) ENGINE=InnoDB AUTO_INCREMENT=2 DEFAULT CHARSET=latin1 COMMENT='original: none. source: /includes/types.inc, /includes/sysna';
/*!40101 SET character_set_client = @saved_cs_client */;
...
-- Dump completed on 2013-06-26  9:11:57
