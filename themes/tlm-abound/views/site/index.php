          ...
          <ul>
          	<li>
          		<span class="summary-icon">
                	<img src="<?php echo $themeBaseUrl ;?>/img/credit.png" width="36" height="36" alt="Monthly Income">
                </span>
            ...
            <li>
            	<span class="summary-icon">
                	<img src="<?php echo $themeBaseUrl ;?>/img/page_white_edit.png" width="36" height="36" alt="Open Invoices">
                </span>
            ...
            <li>
            	<span class="summary-icon">
                	<img src="<?php echo $themeBaseUrl ;?>/img/page_white_excel.png" width="36" height="36" alt="Open Quotes<">
                </span>
            ...
            <li>
            	<span class="summary-icon">
                	<img src="<?php echo $themeBaseUrl ;?>/img/group.png" width="36" height="36" alt="Active Members">
                </span>
            ...
            <li>
            	<span class="summary-icon">
                	<img src="<?php echo $themeBaseUrl ;?>/img/folder_page.png" width="36" height="36" alt="Recent Conversions">
                </span>
