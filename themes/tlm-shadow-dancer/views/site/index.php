<?php  
  ...
  $cs->registerScriptFile($themeBaseUrl.'/js/jquery.gvChart-1.0.1.min.js');
  $cs->registerScriptFile($themeBaseUrl.'/js/pbs.init.js');
  $cs->registerCssFile($themeBaseUrl.'/css/jquery.css');
