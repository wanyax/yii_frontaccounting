...
class EColumns extends CJuiSortable
{
	...
	public function init()
	{
		...
		//is form with new columns submitted ?
	...
	public function run()
	{
		...
		//submit button
		echo '<div>';
		if($this->buttonApply) echo $this->buttonApply;
		if($this->buttonCancel) echo $this->buttonCancel;
		if($this->buttonReset) echo $this->buttonReset;
		echo '</div>';
	...
	protected function loadVisibleKeys($id)
	{
		...
		if($strKeys === false and is_array($this->initialColumns) and count($this->initialColumns)){
			$this->_visibleKeys=$this->initialColumns;
		} elseif($strKeys === false) {
