...
class Lookup extends CActiveRecord
{
	...
	public function rules()
	{
		...
		return array(
			...
			array('created_by, updated_by, is_deleted, deleted_by, code, position', 'numerical', 'integerOnly'=>true),
			array('name, type', 'length', 'max'=>128),
			array('created_time, updated_time, deleted_time', 'safe'),
			// The following rule is used by search().
			// Please remove those attributes that should not be searched.
			array('id, created_time, created_by, updated_time, updated_by, is_deleted, deleted_time, deleted_by, name, code, type, position', 'safe', 'on'=>'search'),
		);
	}
