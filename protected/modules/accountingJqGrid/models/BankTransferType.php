...
/**
 * This is the model class for table "{{bank_transfer_type}}".
 *
 * The followings are the available columns in table '{{bank_transfer_type}}':
 * @property integer $id
 ...
 */
class BankTransferType extends CActiveRecord
{
	/**
	 * Returns the static model of the specified AR class.
	 * @param string $className active record class name.
	 * @return BankTransferType the static model class
	 */
