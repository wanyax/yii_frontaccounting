...
class ExchangeRate extends CActiveRecord
{
	...
	public function rules()
	{
		...
		return array(
			...
			array('created_by, updated_by, is_deleted, deleted_by, currency_id', 'numerical', 'integerOnly'=>true),
			array('rate_buy, rate_sell', 'numerical'),
			array('created_time, updated_time, deleted_time', 'safe'),
			// The following rule is used by search().
			// Please remove those attributes that should not be searched.
			array('id, created_time, created_by, updated_time, updated_by, is_deleted, deleted_time, deleted_by, currency_id, rate_buy, rate_sell, date', 'safe', 'on'=>'search'),
		);
	}
