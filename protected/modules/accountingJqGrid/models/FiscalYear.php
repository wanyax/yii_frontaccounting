...
class FiscalYear extends CActiveRecord
{
	...
	public function rules()
	{
		...
		return array(
			array('begin, end, is_closed', 'required'),
			array('created_by, updated_by, is_deleted, deleted_by, is_closed', 'numerical', 'integerOnly'=>true),
			array('created_time, updated_time, deleted_time', 'safe'),
			// The following rule is used by search().
			// Please remove those attributes that should not be searched.
			array('id, created_time, created_by, updated_time, updated_by, is_deleted, deleted_time, deleted_by, begin, end, is_closed', 'safe', 'on'=>'search'),
		);
	}
	...
	public function relations()
	{
		...
		return array(
			'auditTrails' => array(self::HAS_MANY, 'AuditTrail', 'fiscal_year_id'),
		);
	}
