 ...
 * @property integer $as_tax_shipping
...
class TaxGroup extends CActiveRecord
{
	...
	public function rules()
	{
		...
		return array(
			array('name, as_tax_shipping, is_active', 'required'),
			array('created_by, updated_by, is_deleted, deleted_by, as_tax_shipping, is_active', 'numerical', 'integerOnly'=>true),
			array('name', 'length', 'max'=>60),
			array('created_time, updated_time, deleted_time', 'safe'),
			// The following rule is used by search().
			// Please remove those attributes that should not be searched.
			array('id, created_time, created_by, updated_time, updated_by, is_deleted, deleted_time, deleted_by, name, as_tax_shipping, is_active', 'safe', 'on'=>'search'),
		);
	}
	...
	public function attributeLabels()
	{
		return array(
			...
			'name' => 'Name',
			'as_tax_shipping' => 'As Tax Shipping',
			'is_active' => 'Is Active',
		);
	}
	...
	public function search()
	{
		...
		$criteria->compare('as_tax_shipping',$this->as_tax_shipping);
