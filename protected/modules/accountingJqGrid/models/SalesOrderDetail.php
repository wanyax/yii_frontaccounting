...
class SalesOrderDetail extends CActiveRecord
{
	...
	public function rules()
	{
		...
		return array(
			...
			array('created_by, updated_by, is_deleted, deleted_by, sales_order_id, stock_master_id', 'numerical', 'integerOnly'=>true),
			...
			array('id, created_time, created_by, updated_time, updated_by, is_deleted, deleted_time, deleted_by, sales_order_id, stock_master_id, description, quantity_sent, unit_price, quantity, discount_percent', 'safe', 'on'=>'search'),
		);
	}
