...
/**
 * This is the model class for table "{{work_order_cost_type}}".
 *
 * The followings are the available columns in table '{{work_order_cost_type}}':
 * @property integer $id
 ...
 */
class WorkOrderCostType extends CActiveRecord
{
	/**
	 * Returns the static model of the specified AR class.
	 * @param string $className active record class name.
	 * @return WorkOrderCostType the static model class
	 */
