 ...
 *
 * The followings are the available columns in table '{{bank_account_type}}':
 * @property integer $id
 ...
 */
class BankAccountType extends CActiveRecord
{
	/**
	 * Returns the static model of the specified AR class.
	 * @param string $className active record class name.
	 * @return BankAccountType the static model class
	 */
	...
	public function relations()
	{
		...
		return array(
			'bankAccounts' => array(self::HAS_MANY, 'BankAccount', 'bank_account_type_id'),
		);
	}
