...
/**
 * This is the model class for table "{{payment_term_type}}".
 *
 * The followings are the available columns in table '{{payment_term_type}}':
 * @property integer $id
 ...
 */
class PaymentTermType extends CActiveRecord
{
	/**
	 * Returns the static model of the specified AR class.
	 * @param string $className active record class name.
	 * @return PaymentTermType the static model class
	 */
	...
	public function relations()
	{
		...
		return array(
			'paymentTerms' => array(self::HAS_MANY, 'PaymentTerm', 'payment_term_type_id'),
		);
	}
