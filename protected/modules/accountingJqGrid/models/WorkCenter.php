...
/**
 * This is the model class for table "{{work_center}}".
 *
 * The followings are the available columns in table '{{work_center}}':
 * @property integer $id
...
class WorkCenter extends CActiveRecord
{
	...
	public function rules()
	{
		...
		return array(
			array('name, description, is_active', 'required'),
			...
			array('id, created_time, created_by, updated_time, updated_by, is_deleted, deleted_time, deleted_by, name, description, is_active', 'safe', 'on'=>'search'),
		);
	}
	...
	public function relations()
	{
		...
		return array(
			...
			'workOrderIssues' => array(self::HAS_MANY, 'WorkOrderIssue', 'work_center_id'),
			'workOrderRequirements' => array(self::HAS_MANY, 'WorkOrderRequirement', 'work_center_id'),
		);
	}
