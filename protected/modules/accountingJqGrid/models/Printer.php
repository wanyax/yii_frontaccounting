...
class Printer extends CActiveRecord
{
	...
	public function rules()
	{
		...
		return array(
			...
			array('created_by, updated_by, is_deleted, deleted_by, port, timeout', 'numerical', 'integerOnly'=>true),
			...
			array('id, created_time, created_by, updated_time, updated_by, is_deleted, deleted_time, deleted_by, name, description, queue, host, port, timeout', 'safe', 'on'=>'search'),
		);
	}
