...
class BudgetTransaction extends CActiveRecord
{
	...
	public function rules()
	{
		...
		return array(
			array('transaction_type_id, transaction_no, date, general_ledger_account_id, memo, amount', 'required'),
			array('created_by, updated_by, is_deleted, deleted_by, transaction_type_id, transaction_no, general_ledger_account_id, dimension1_id, dimension2_id, person_type_id', 'numerical', 'integerOnly'=>true),
			array('amount', 'numerical'),
			array('created_time, updated_time, deleted_time, person_id', 'safe'),
			// The following rule is used by search().
			// Please remove those attributes that should not be searched.
			array('id, created_time, created_by, updated_time, updated_by, is_deleted, deleted_time, deleted_by, transaction_type_id, transaction_no, date, general_ledger_account_id, memo, amount, dimension1_id, dimension2_id, person_type_id, person_id', 'safe', 'on'=>'search'),
		);
	}
