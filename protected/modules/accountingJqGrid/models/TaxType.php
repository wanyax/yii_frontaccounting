 ...
 * @property GlAccount $purchasingAccount
...
class TaxType extends CActiveRecord
{
	...
	public function rules()
	{
		...
		return array(
			array('name, rate, sales_account_id, purchasing_account_id, is_active', 'required'),
			array('created_by, updated_by, is_deleted, deleted_by, sales_account_id, purchasing_account_id, is_active', 'numerical', 'integerOnly'=>true),
			array('rate', 'numerical'),
			array('name', 'length', 'max'=>60),
			array('created_time, updated_time, deleted_time', 'safe'),
			// The following rule is used by search().
			// Please remove those attributes that should not be searched.
			array('id, created_time, created_by, updated_time, updated_by, is_deleted, deleted_time, deleted_by, name, rate, sales_account_id, purchasing_account_id, is_active', 'safe', 'on'=>'search'),
		);
	}
	...
	public function relations()
	{
		...
		return array(
			...
			'purchasingAccount' => array(self::BELONGS_TO, 'GlAccount', 'purchasing_account_id'),
