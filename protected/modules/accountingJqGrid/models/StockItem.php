...
class StockItem extends CActiveRecord
{
	...
	public function rules()
	{
		...
		return array(
			array('code, stock_master_id, description, stock_category_id, quantity, as_foreign, is_active', 'required'),
			array('created_by, updated_by, is_deleted, deleted_by, stock_master_id, stock_category_id, as_foreign, is_active', 'numerical', 'integerOnly'=>true),
			...
			array('id, created_time, created_by, updated_time, updated_by, is_deleted, deleted_time, deleted_by, code, stock_master_id, description, stock_category_id, quantity, as_foreign, is_active', 'safe', 'on'=>'search'),
		);
	}
	...
	public function relations()
	{
		...
		return array(
			'grnBatchItems' => array(self::HAS_MANY, 'GrnBatchItem', 'stock_item_id'),
	...
	public function search()
	{
		...
		$criteria->compare('as_foreign',$this->as_foreign);
