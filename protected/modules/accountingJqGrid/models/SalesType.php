...
class SalesType extends CActiveRecord
{
	...
	public function rules()
	{
		...
		return array(
			array('name, is_tax_included, factor, is_active', 'required'),
			array('created_by, updated_by, is_deleted, deleted_by, is_tax_included, is_active', 'numerical', 'integerOnly'=>true),
			array('factor', 'numerical'),
			array('name', 'length', 'max'=>50),
			array('created_time, updated_time, deleted_time', 'safe'),
			// The following rule is used by search().
			// Please remove those attributes that should not be searched.
			array('id, created_time, created_by, updated_time, updated_by, is_deleted, deleted_time, deleted_by, name, is_tax_included, factor, is_active', 'safe', 'on'=>'search'),
		);
	}
	...
	public function relations()
	{
		...
		return array(
			...
			'salesOrders' => array(self::HAS_MANY, 'SalesOrder', 'sales_type_id'),
