...
class SalesPrice extends CActiveRecord
{
	...
	public function rules()
	{
		...
		return array(
			...
			array('created_by, updated_by, is_deleted, deleted_by, stock_master_id, sales_type_id, currency_id', 'numerical', 'integerOnly'=>true),
			array('price', 'numerical'),
			array('created_time, updated_time, deleted_time', 'safe'),
			// The following rule is used by search().
			// Please remove those attributes that should not be searched.
			array('id, created_time, created_by, updated_time, updated_by, is_deleted, deleted_time, deleted_by, stock_master_id, sales_type_id, currency_id, price', 'safe', 'on'=>'search'),
		);
	}
