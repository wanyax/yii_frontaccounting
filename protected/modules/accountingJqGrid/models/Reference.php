...
class Reference extends CActiveRecord
{
	...
	public function rules()
	{
		...
		return array(
			array('id, type, code', 'required'),
			array('id, created_by, updated_by, is_deleted, deleted_by, type', 'numerical', 'integerOnly'=>true),
			array('code', 'length', 'max'=>100),
			array('created_time, updated_time, deleted_time', 'safe'),
			// The following rule is used by search().
			// Please remove those attributes that should not be searched.
			array('id, created_time, created_by, updated_time, updated_by, is_deleted, deleted_time, deleted_by, type, code', 'safe', 'on'=>'search'),
		);
	}
