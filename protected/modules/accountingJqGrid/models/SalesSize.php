...
/**
 * This is the model class for table "{{sales_size}}".
 *
 * The followings are the available columns in table '{{sales_size}}':
 * @property integer $id
 ...
 */
class SalesSize extends CActiveRecord
{
	/**
	 * Returns the static model of the specified AR class.
	 * @param string $className active record class name.
	 * @return SalesSize the static model class
	 */
	...
	public function relations()
	{
		...
		return array(
			'customerBranches' => array(self::HAS_MANY, 'CustomerBranch', 'sales_size_id'),
		);
	}
