...
/**
 * This is the model class for table "{{contact_entity}}".
 *
 * The followings are the available columns in table '{{contact_entity}}':
 * @property integer $id
 ...
 * @property ContactCategory[] $contactCategories
 */
class ContactEntity extends CActiveRecord
{
	/**
	 * Returns the static model of the specified AR class.
	 * @param string $className active record class name.
	 * @return ContactEntity the static model class
	 */
	...
	public function relations()
	{
		...
		return array(
			'contactCategories' => array(self::HAS_MANY, 'ContactCategory', 'contact_entity_id'),
		);
	}
