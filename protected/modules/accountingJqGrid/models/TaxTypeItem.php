...
class TaxTypeItem extends CActiveRecord
{
	...
	public function rules()
	{
		...
		return array(
			array('name, as_exemption, is_active', 'required'),
			array('created_by, updated_by, is_deleted, deleted_by, as_exemption, is_active', 'numerical', 'integerOnly'=>true),
			array('name', 'length', 'max'=>60),
			array('created_time, updated_time, deleted_time', 'safe'),
			// The following rule is used by search().
			// Please remove those attributes that should not be searched.
			array('id, created_time, created_by, updated_time, updated_by, is_deleted, deleted_time, deleted_by, name, as_exemption, is_active', 'safe', 'on'=>'search'),
		);
	}
	...
	public function search()
	{
		...
		$criteria->compare('as_exemption',$this->as_exemption);
