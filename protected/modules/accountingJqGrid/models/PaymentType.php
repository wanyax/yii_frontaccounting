...
class PaymentType extends CActiveRecord
{
	...
	public function relations()
	{
		...
		return array(
			'bankTransactions' => array(self::HAS_MANY, 'BankTransaction', 'person_type_id'),
			'budgetTransactions' => array(self::HAS_MANY, 'BudgetTransaction', 'person_type_id'),
			'glTransactions' => array(self::HAS_MANY, 'GlTransaction', 'person_type_id'),
		);
	}
