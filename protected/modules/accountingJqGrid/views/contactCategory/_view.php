...
<div class="view">
	...
	<b><?php echo CHtml::encode($data->getAttributeLabel('contact_entity_id')); ?>:</b>
	<?php echo CHtml::encode($data->contact_entity_id); ?>
	<br />
	...
	<b><?php echo CHtml::encode($data->getAttributeLabel('as_system')); ?>:</b>
	<?php echo CHtml::encode($data->as_system); ?>
	<br />
