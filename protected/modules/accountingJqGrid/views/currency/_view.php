...
<div class="view">
	...
	<b><?php echo CHtml::encode($data->getAttributeLabel('hundreds_name')); ?>:</b>
	<?php echo CHtml::encode($data->hundreds_name); ?>
	<br />

	<b><?php echo CHtml::encode($data->getAttributeLabel('is_auto_update')); ?>:</b>
	<?php echo CHtml::encode($data->is_auto_update); ?>
	<br />
