...
class MeasureUnitController extends AppController
{
	/**
	...
	public function actionAdmin()
	{
		...
		if(isset($_GET['MeasureUnit']))
			$model->attributes=$_GET['MeasureUnit'];
	 ...
	 * @param MeasureUnit $model the model to be validated
	 */
