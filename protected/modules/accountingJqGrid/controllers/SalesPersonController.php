...
class SalesPersonController extends AppController
{
	/**
	...
	{
	    $salesperson = SalesPerson::model();
	    $criteria = $this->getCriteriaFromRequest($salesperson);
		if(!$criteria) {
			header("HTTP/1.0 400 Bad Request");
			return;
	    }
		$salespersons = $salesperson->findAll($criteria);
