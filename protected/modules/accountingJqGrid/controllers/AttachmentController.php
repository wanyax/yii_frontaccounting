...
class AttachmentController extends AppController
{
	...
	public function actionAdminDataJson()
	{
	    ...
	    $criteria = $this->getCriteriaFromRequest($attachment);
	    ...
	    $attachments = $attachment->with(array('transactionType' => array('select' => 'fa_transaction_type.name')))->findAll($criteria);
